...
In this recipe, we introduce the syntax for *model freezing* in TorchScript.
...
Conclusion
-----------
we learned about model freezing. Freezing is a useful technique to optimize models for
inference and it also can significantly reduce TorchScript warm up time.
"""
